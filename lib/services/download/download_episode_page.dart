...
class _DownloadEpisodePageState extends State<DownloadEpisodePage>
  ...
  void _showDialog(task, userDetails) {
    ...
    var dCount= userDetails.limit  / userDetails.screen ;
  ...
  void _showMsg() {
    var userDetails = Provider.of<UserProfileProvider>(context, listen: false).userProfileModel;
    if (userDetails.paypal.length == 0 || userDetails.user.subscriptions.length == 0 || userDetails.user.subscriptions == null) {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      final userProfile = Provider.of<UserProfileProvider>(context, listen: false).userProfileModel;
