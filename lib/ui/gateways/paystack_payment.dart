...
// import 'package:nexthour/ui/shared/paystack_paynow_button.dart';
...
//     final sendResponse = await http.post(APIData.sendPaystackDetails, body: {
//       "reference": "$ref",
//       "amount": "$am",
//       "plan_id": "$plan1",
//     }, headers: {
...
//                     title: Text("Saving Payment Info", style: TextStyle(color: Colors.black87),),
//                     content: Container(
//                       height: 70.0,
//                       width: 150.0,
//                       child: Center(
...
//       var paymentKey = Provider.of<PaymentKeyProvider>(context, listen: false).paymentKeyModel;
//       if(paymentKey.paystack == "null" || paymentKey.paystack == null || paymentKey.paystack == ""){
//         Fluttertoast.showToast(msg: "Key not entered.");
//       }else{
//         // PaystackPlugin.initialize(publicKey: paymentKey.paystack);
//       }
//     });
//     setState(() {
//       isBack = true;
...
//             child: Image.asset("assets/paystacklogo.png", scale: 1.0, width: 150.0,),
//           )
//         ],
//       ),
//     );
...
//                               child: PayStackPlatformButton('Pay Now', () {
// //                                if(planDetails[widget.index].currency == "NGN"){
// //                                  Fluttertoast.showToast(msg: "Paystack supports only NGN currency");
// //                                }else{
//                                   _handleCheckout(widget.payAmount == null ? planDetails[widget.index].amount : widget.payAmount, userDetails.user.email, planDetails[widget.index].id);
// //                                }
//                               },)),
//                         ),
//                       ],
