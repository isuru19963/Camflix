    ...
    for(int p = 0; p<movieTvList.length; p++){
      for(int s = 0; s<movieTvList[p].genre.length; s++){
        if("${movieTvList[p].genre[s]}" == "$id"){
          ...
          var actors = movieTvList[p].actorId == null ? null : movieTvList[p].actorId.split(",").toList();
          var audios = movieTvList[p].aLanguage == null ? null : movieTvList[p].aLanguage.split(",").toList();
          var directors = movieTvList[p].directorId == null ? null : movieTvList[p].directorId.split(",").toList();
          genreDataList.add(Datum(
            ...
            seasons: List.generate(movieTvList[p].seasons == null ? 0 : movieTvList[p].seasons.length, (sIndex) {
              var seasonActors = movieTvList[p].seasons[sIndex].actorId == ""  || movieTvList[p].seasons[sIndex].actorId == null ? null
                  : movieTvList[p].seasons[sIndex].actorId.split(",").toList();
              var audioLang = movieTvList[p].seasons[sIndex].aLanguage == ""  || movieTvList[p].seasons[sIndex].aLanguage == null ? null
                  : movieTvList[p].seasons[sIndex].aLanguage.split(",").toList();
              return Season(
          ...
          return Container(
            ...
            child: Material(
              ...
              child: InkWell(
                onTap: () {
                  ...
                  Navigator.pushNamed(context, RoutePaths.genreVideos, arguments:
                  VideoGridScreen(genres[index].id, genres[index].name, genreDataList));
                },
                child: Container(
                  alignment: Alignment.center,
                  child: Text("${genres[index].name}", style: TextStyle(fontWeight: FontWeight.w600, fontSize: 16.0),),
                ),
              ),
            ...
            decoration: BoxDecoration(
                ...
                gradient: LinearGradient(
                  ...
                  colors: Constants.gradientColors[Random().nextInt(Constants.gradientColors.length)],
                )
            ),
          );
      }),
