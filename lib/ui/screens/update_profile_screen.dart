                ...
                content: Container(
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      Icon(FontAwesomeIcons.checkCircle, size: 40.0, color: activeDotColor),
                      SizedBox(
                        height: 8.0,
                      ),
...
//  This Future picks date using material date picker
  ...
  WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
    ...
    newMobile = _editMobileController.text;
    _editNameController.text = "${userDetails.user.name}" == null ? '' : "${userDetails.user.name}";
    _editDOBController.text=  "${userDetails.user.dob}" == null ? '' : "${userDetails.user.dob}";
    _editMobileController.text =  "${userDetails.user.mobile}" == "null" ? '' : "${userDetails.user.mobile}";
  });
  }
  @override
                      ...
                      child: Card(
                        ...
                        child:   ClipRRect(
                          borderRadius: new BorderRadius.only(
                              bottomLeft: Radius.circular(25.0),
                              bottomRight: Radius.circular(25.0)),
                          child: tmpFile == null ? "${userDetails.user.image}" == null || "${userDetails.user.image}" == "null" ? Image.asset(
                            "assets/avatar.png",
                            fit: BoxFit.cover,
                            scale: 1.7,
                          ): Image.network(
