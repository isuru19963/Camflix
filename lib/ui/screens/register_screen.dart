...
// Sign up button
    ...
    if (form.validate() == true) {
      try {
        ...
        if (loginProvider.loginStatus == true) {
          ...
          Fluttertoast.showToast(msg: "Registration Failed..!", backgroundColor: Colors.red, textColor: Colors.white,
  ...
  showAlertDialog(BuildContext context, String msg) {
    ...
    AlertDialog alert = AlertDialog(
      ...
      title: Text("Sign Up Successful!", textAlign: TextAlign.center, style: TextStyle(color: primaryBlue, fontSize: 22.0, fontWeight: FontWeight.bold),),
