        ...
        return Container(
          ...
          child: Material(
            ...
            child: InkWell(
                ...
                child: Column(
                  ...
                  children: [
                    ClipRRect(
                      ...
                      child: Image.network("${APIData.blogImageUri}${blog.appModel.blogs[index].image}",
                        height: 200,
                        fit: BoxFit.cover,
                    ...
                    Padding(padding: EdgeInsets.symmetric(horizontal: 10.0),
                      child: Text("${blog.appModel.blogs[index].title}", style: TextStyle(fontSize: 18.0,
                    ...
                    Padding(padding: EdgeInsets.symmetric(horizontal: 10.0), child: Text(
                      DateFormat.yMMMd().format(DateTime.parse("${blog.appModel.blogs[index].updatedAt}"),),
                      style: TextStyle(
              ...
              onTap: () => Navigator.pushNamed(context, RoutePaths.blog, arguments: BlogScreen(index)),
            ),
          ),
        );
      }),
