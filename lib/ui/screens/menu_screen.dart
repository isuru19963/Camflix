        ...
        child: DrawerHeader(
          ...
          child: Column(
            children: <Widget>[
              ...
              userDetails.active == "1"  || userDetails.active == 1 ? userDetails.payment == "Free" ?
              profileImage() : Container(
                ...
                child: ListView.builder(
                    ...
                    itemCount: userDetails.screen,
                    itemBuilder: (BuildContext context, int index) {
                      return InkWell(
                        child: "${screenList[index].id + 1}" == '$screenCount' ? Column(
                          children: <Widget>[
                            Container(
                              height: 70.0,
  ...
  screenLogout() async {
    ...
    if(userDetails.payment == "Free"){
      screenLogOutResponse = await http.post(
          APIData.screenLogOutApi, headers: {
        HttpHeaders.authorizationHeader: "Bearer $authToken"
      });
    }else{
