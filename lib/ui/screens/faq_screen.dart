...
//  This Widget will generate list of all question.
  Widget expansionTile(int index, faqList) {
    ...
    return ExpansionTile(
      ...
      title: Text('${faqList[index].question}',style: TextStyle(color: Color.fromRGBO( 50, 150, 220, 1.0)),),
...
//  Scaffold body
  Widget scaffoldBody(){
    ...
    return ListView.builder(
      ...
      itemBuilder: (BuildContext context, int index) => expansionTile(index, faqList),
    );
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: _visible == false ? Center(child: CircularProgressIndicator(valueColor: new AlwaysStoppedAnimation<Color>(Colors.green),),) : scaffoldBody(),
    );
  }
}