  ...
  Widget build(BuildContext context) {
    return Expanded(
      child: Material(
        ...
        child: InkWell(
          child: _visible == false ? Center(child: CircularProgressIndicator(),) : Column(
            children: [
              checkWishlist == false ?  Icon(Icons.add, color: Colors.white, size: 30.0,) :
              Icon(Icons.check, color: activeDotColor, size: 30.0,),
              new Padding(
                padding:
              ...
              Text(
                ...
                style: TextStyle(
                    ...
                    letterSpacing: 0.0,
                    color: checkWishlist == true ? activeDotColor: Colors.white
                  // color: Colors.white
                ),
              ),
            ],
