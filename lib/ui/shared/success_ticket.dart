...
class SuccessTicket extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    var currency = Provider.of<AppConfig>(context, listen: false).appModel.config.currencyCode;
    return WillPopScope(
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              ListTile(
                ...
                subtitle: Text(subDate,style: TextStyle(color: Theme.of(context).primaryColorLight),),
                trailing: Text(time,style: TextStyle(color: Colors.black)),
              ),
              ListTile(
                title: Text(userDetails.user.name,style: TextStyle(color: Colors.black),),
                subtitle: Text(userDetails.user.email,style: TextStyle(color: Theme.of(context).primaryColorLight),),
              ...
              ListTile(
                ...
                subtitle: Text("$planAmount"+" $currency",
...
class SuccessTicket2 extends StatelessWidget {
  SuccessTicket2(this.msgResponse, this.subdate, this.name, this.time, this.planAmount);
  final  msgResponse;
  final subdate;
  final name;
  final time;
