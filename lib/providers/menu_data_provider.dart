...
import 'package:nexthour/models/menu_by_category.dart';
    ...
    if (response.statusCode == 200) {
      ...
      for(int i = 0; i<menuByCategory.data.length; i++){
        for(int j=0; j<menuByCategory.data[i].length; j++){
          var genreData = menuByCategory.data[i][j].genreId == null ? null : menuByCategory.data[i][j].genreId.split(",").toList();
          var actors = menuByCategory.data[i][j].actorId == null ? null : menuByCategory.data[i][j].actorId.split(",").toList();
          var audios = menuByCategory.data[i][j].aLanguage == null ? null : menuByCategory.data[i][j].aLanguage.split(",").toList();
          var directors = menuByCategory.data[i][j].directorId == null ? null : menuByCategory.data[i][j].directorId.split(",").toList();
      ...
      for(int i = 0; i<menuDataList.length; i++){
        if(menuDataList[i].type == DatumType.M){
          var audios = menuDataList[i].aLanguage == null || menuDataList[i].aLanguage == "null" ? null :
          ...
          menuDataList.removeWhere((element) => element.status == 0 || element.status == "0");
        }
        else{
          menuCatTvSeriesList.add(Datum(
            ...
            genreId: menuDataList[i].genreId,
            type: menuDataList[i].type,
            seasons: List.generate(menuDataList[i].seasons == null ? 0 : menuDataList[i].seasons.length, (sIndex) {
              var actors = menuDataList[i].seasons[sIndex].actorId == ""  || menuDataList[i].seasons[sIndex].actorId == null ? null
                  : menuDataList[i].seasons[sIndex].actorId.split(",").toList();
              return Season(
                ...
                episodes: List.generate(
                    menuDataList[i].seasons[sIndex].episodes == null ? 0 : menuDataList[i].seasons[sIndex].episodes.length,
                        (eIndex) {
                      return Episode(
                        id: menuDataList[i].seasons[sIndex].episodes[eIndex].id,
                        thumbnail: menuDataList[i].seasons[sIndex].episodes[eIndex].thumbnail,
                        title: menuDataList[i].seasons[sIndex].episodes[eIndex].title,
                        detail: menuDataList[i].seasons[sIndex].episodes[eIndex].detail,
                        duration: menuDataList[i].seasons[sIndex].episodes[eIndex].duration,
                        createdAt: menuDataList[i].seasons[sIndex].episodes[eIndex].createdAt,
                        updatedAt: menuDataList[i].seasons[sIndex].episodes[eIndex].updatedAt,
                        episodeNo: menuDataList[i].seasons[sIndex].episodes[eIndex].episodeNo,
                        aLanguage: menuDataList[i].seasons[sIndex].episodes[eIndex].aLanguage,
                        released: menuDataList[i].seasons[sIndex].episodes[eIndex].released,
                        seasonsId: menuDataList[i].seasons[sIndex].episodes[eIndex].seasonsId,
                        videoLink: menuDataList[i].seasons[sIndex].episodes[eIndex].videoLink,
                      );
                    }),
          ...
          menuCatTvSeriesList.removeWhere((element) => element.status == 0 || element.status == "0");
        }
      }
    }
      for(int i=0; i<menuCatMoviesList.length; i++){
        if(menuCatMoviesList[i].live == 1 || "${menuCatMoviesList[i].live}" == "1"){
          var audios = menuCatMoviesList[i].aLanguage == null || menuCatMoviesList[i].aLanguage == "null" ? null :
