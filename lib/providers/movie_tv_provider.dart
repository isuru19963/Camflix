...
class MovieTVProvider with ChangeNotifier {
  ...
  Future<MovieTv> getMoviesTVData(BuildContext context) async {
    ...
    // try {
      ...
      if (response.statusCode == 200) {
        ...
        fetchMovieTVSeriesList(movieTv, genreList, actorList, directorList, audioList);
        fetchTVSeriesList(movieTvList, genreList, actorList, directorList, audioList);
          ...
          for (int j = 0; j < topMVList.length; j++) {
              if(topMVList[j].tvSeriesId == null){
                if(moviesList[i].id == topMVList[j].movieId){
                  var genreData = moviesList[i].genreId == null ? null : moviesList[i].genreId.split(",").toList();
                  var actors = moviesList[i].actorId == null ? null : moviesList[i].actorId.split(",").toList();
                  var audios = moviesList[i].aLanguage == null ? null : moviesList[i].aLanguage.split(",").toList();
                  var directors = moviesList[i].directorId == null ? null : moviesList[i].directorId.split(",").toList();
                  topVideoList.add(Datum(
                    ...
                    subtitleList: moviesList[i].subtitleList,
                    subtitleFiles: moviesList[i].subtitleFiles,
          ...
          for (int j = 0; j < topMVList.length; j++) {
            if(topMVList[j].movieId == null){
              if(tvSeriesList[i].id == topMVList[j].tvSeriesId){
                var genreData = tvSeriesList[i].genreId == null ? null : tvSeriesList[i].genreId.split(",").toList();
                var actors = tvSeriesList[i].actorId == null ? null : tvSeriesList[i].actorId.split(",").toList();
                var audios = tvSeriesList[i].aLanguage == null ? null : tvSeriesList[i].aLanguage.split(",").toList();
                var directors = tvSeriesList[i].directorId == null ? null : tvSeriesList[i].directorId.split(",").toList();
                topVideoList.add(Datum(
                  ...
                  subtitleList: tvSeriesList[i].subtitleList,
                  subtitleFiles: tvSeriesList[i].subtitleFiles,
                  ...
                  seasons: List.generate(tvSeriesList[i].seasons == null ? 0 : tvSeriesList[i].seasons.length, (sIndex) {
                    var seasonActors = tvSeriesList[i].seasons[sIndex].actorId == null || tvSeriesList[i].seasons[sIndex].actorId == ""
                        ? null : tvSeriesList[i].seasons[sIndex].actorId;
                    var audios = tvSeriesList[i].seasons[sIndex].aLanguage == null ? null : tvSeriesList[i].seasons[sIndex].aLanguage;
                    return Season(
                      ...
                      episodes: List.generate(
                          tvSeriesList[i].seasons[sIndex].episodes == null
                              ? 0
                              : tvSeriesList[i].seasons[sIndex].episodes.length,
                              (eIndex) {
                            return Episode(
                              id: tvSeriesList[i].seasons[sIndex].episodes[eIndex]
                                  .id,
                              thumbnail: tvSeriesList[i].seasons[sIndex]
                                  .episodes[eIndex].thumbnail,
                              title: tvSeriesList[i].seasons[sIndex]
                                  .episodes[eIndex].title,
                              detail: tvSeriesList[i].seasons[sIndex]
                                  .episodes[eIndex].detail,
                              duration: tvSeriesList[i].seasons[sIndex]
                                  .episodes[eIndex].duration,
                              createdAt: tvSeriesList[i].seasons[sIndex]
                                  .episodes[eIndex].createdAt,
                              updatedAt: tvSeriesList[i].seasons[sIndex]
                                  .episodes[eIndex].updatedAt,
                              episodeNo: tvSeriesList[i].seasons[sIndex]
                                  .episodes[eIndex].episodeNo,
                              aLanguage: tvSeriesList[i].seasons[sIndex]
                                  .episodes[eIndex].aLanguage,
                              released: tvSeriesList[i].seasons[sIndex]
                                  .episodes[eIndex].released,
                              seasonsId: tvSeriesList[i].seasons[sIndex]
                                  .episodes[eIndex].seasonsId,
                              videoLink: tvSeriesList[i].seasons[sIndex]
                      ...
                      subtitleList: tvSeriesList[i].seasons[sIndex].subtitleList,
                    );
                  }),
                  genre: List.generate(genreData == null ? 0 : genreData.length,
                          (int genreIndex) {
        ...
        topVideoList.removeWhere((element) => element.status == 0 || "${element.status}" == "0");
      } else
        {
  ...
  fetchMovieTVSeriesList(movieTv, genreList, actorList, directorList, audioList){
    movieTvList = List.generate(movieTv.data.length, (index) {
      var genreData = movieTv.data[index].genreId == null ? null : movieTv.data[index].genreId.split(",").toList();
      var actors = movieTv.data[index].actorId == null ? null : movieTv.data[index].actorId.split(",").toList();
      var directors = movieTv.data[index].directorId == null ? null : movieTv.data[index].directorId.split(",").toList();
      var audios = movieTv.data[index].aLanguage == null ? null : movieTv.data[index].aLanguage.split(",").toList();
      return Datum(
        ...
        comments: List.generate(movieTv.data[index].comments == null ? 0 : movieTv.data[index].comments.length, (cIndex) {
          return Comment(
        ...
        seasons: List.generate(movieTv.data[index].seasons == null ? 0 : movieTv.data[index].seasons.length, (sIndex) {
          var seasonActors = movieTv.data[index].seasons[sIndex].actorId == ""  || movieTv.data[index].seasons[sIndex].actorId == null ? null
              : movieTv.data[index].seasons[sIndex].actorId.split(",").toList();
          var seasonAudio = movieTv.data[index].seasons[sIndex].aLanguage == ""  || movieTv.data[index].seasons[sIndex].aLanguage == null ? null
              : movieTv.data[index].seasons[sIndex].aLanguage.split(",").toList();
          return Season(
            ...
            episodes: List.generate(
                movieTv.data[index].seasons[sIndex].episodes == null ? 0 : movieTv.data[index].seasons[sIndex].episodes.length,
                    (eIndex) {
                  return Episode(
                    id: movieTv.data[index].seasons[sIndex].episodes[eIndex].id,
                    thumbnail: movieTv.data[index].seasons[sIndex].episodes[eIndex].thumbnail,
                    title: movieTv.data[index].seasons[sIndex].episodes[eIndex].title,
                    detail: movieTv.data[index].seasons[sIndex].episodes[eIndex].detail,
                    duration: movieTv.data[index].seasons[sIndex].episodes[eIndex].duration,
                    createdAt: movieTv.data[index].seasons[sIndex].episodes[eIndex].createdAt,
                    updatedAt: movieTv.data[index].seasons[sIndex].episodes[eIndex].updatedAt,
                    episodeNo: movieTv.data[index].seasons[sIndex].episodes[eIndex].episodeNo,
                    aLanguage: movieTv.data[index].seasons[sIndex].episodes[eIndex].aLanguage,
                    released: movieTv.data[index].seasons[sIndex].episodes[eIndex].released,
                    seasonsId: movieTv.data[index].seasons[sIndex].episodes[eIndex].seasonsId,
                    videoLink: movieTv.data[index].seasons[sIndex].episodes[eIndex].videoLink,
                  );
                }),
            ...
            audiosList: List.generate(audioList.length, (actIndex) {
              var actorsId = audioList[actIndex].id.toString();
              var audioIdList = List.generate(seasonAudio == null ? 0 : seasonAudio.length,
                      (int idIndex) {
            ...
            subtitleList: movieTv.data[index].seasons[sIndex].subtitleList,
          );
        }),
      );
    });
    movieTvList.removeWhere((element) => element.status == 0 || "${element.status}" == "0");
  }

  fetchTVSeriesList(movieTvList, genreList, actorList, directorList, audioList){
    for(int i=0; i<movieTvList.length; i++){
      var genreData = movieTvList[i].genreId == null ? null : movieTvList[i].genreId.split(",").toList();
      var actors = movieTvList[i].actorId == null ? null : movieTvList[i].actorId.split(",").toList();
      var directors = movieTvList[i].directorId == null ? null : movieTvList[i].directorId.split(",").toList();
      var audios = movieTvList[i].aLanguage == null ? null : movieTvList[i].aLanguage.split(",").toList();
      if(movieTvList[i].type == DatumType.T){
        tvSeriesList.add(Datum(
          ...
          comments: List.generate(movieTvList[i].comments == null ? 0 : movieTvList[i].comments.length, (cIndex) {
            return Comment(
          ...
          seasons: List.generate(movieTvList[i].seasons == null ? 0 : movieTvList[i].seasons.length, (sIndex) {
            return Season(
              ...
              episodes: List.generate(
                  movieTvList[i].seasons[sIndex].episodes == null ? 0 : movieTvList[i].seasons[sIndex].episodes.length,
                      (eIndex) {
                    return Episode(
                      id: movieTvList[i].seasons[sIndex].episodes[eIndex].id,
                      thumbnail: movieTvList[i].seasons[sIndex].episodes[eIndex].thumbnail,
                      title: movieTvList[i].seasons[sIndex].episodes[eIndex].title,
                      detail: movieTvList[i].seasons[sIndex].episodes[eIndex].detail,
                      duration: movieTvList[i].seasons[sIndex].episodes[eIndex].duration,
                      createdAt: movieTvList[i].seasons[sIndex].episodes[eIndex].createdAt,
                      updatedAt: movieTvList[i].seasons[sIndex].episodes[eIndex].updatedAt,
                      episodeNo: movieTvList[i].seasons[sIndex].episodes[eIndex].episodeNo,
                      aLanguage: movieTvList[i].seasons[sIndex].episodes[eIndex].aLanguage,
                      released: movieTvList[i].seasons[sIndex].episodes[eIndex].released,
                      seasonsId: movieTvList[i].seasons[sIndex].episodes[eIndex].seasonsId,
                      videoLink: movieTvList[i].seasons[sIndex].episodes[eIndex].videoLink,
                    );
                  }),
              ...
              subtitleList: movieTvList[i].seasons[sIndex].subtitleList,
            );
          }),
        )
        );
        tvSeriesList.removeWhere((element) => element.status == 0 || "${element.status}" == "0");
      }else{
        ...
        moviesList.removeWhere((element) => element.status == 0 || "${element.status}" == "0");
       }
    }
  }
}
