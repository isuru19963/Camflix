  ...
  Future<ActorMoviesDetails> getActorsMovies(BuildContext context, String id) async {
    ...
    try {
      ...
      if(response.statusCode == 200){
        ...
        actorMovies = List<Actormovie>.generate(actorMoviesDetails.actormovies.length, (index){
        ...
        actorTVSeries =  List<Actormovie>.generate(actorMoviesDetails.actormovies.length, (index){
          if("${actorMoviesDetails.actormovies[index].type}" == "S") {
            return Actormovie(
              ...
              subtitleList: actorMoviesDetails.actormovies[index].subtitleList,
            ...
            for(int k=0; k<actorTVSeries.length; k++){
              if(movieTvList[i].id == actorTVSeries[k].tvSeriesId){
                actorMoviesTVList.add(Datum(
                  ...
                  subtitleList: movieTvList[i].subtitleList,
                  subtitleFiles: movieTvList[i].subtitleFiles,
                  ...
                  seasons: List.generate(movieTvList[i].seasons == null ? 0 : movieTvList[i].seasons.length, (sIndex) {
                    var seasonActors = movieTvList[i].seasons[sIndex].actorId == ""  || movieTvList[i].seasons[sIndex].actorId == null ? null
                        : movieTvList[i].seasons[sIndex].actorId.split(",").toList();
                    var audioLang = movieTvList[i].seasons[sIndex].aLanguage == ""  || movieTvList[i].seasons[sIndex].aLanguage == null ? null
                        : movieTvList[i].seasons[sIndex].aLanguage.split(",").toList();
                    return Season(
                      ...
                      episodes: List.generate(
                          movieTvList[i].seasons[sIndex].episodes == null ? 0 : movieTvList[i].seasons[sIndex].episodes.length, (eIndex) {
                            return Episode(
                      ...
                      audiosList: List.generate(audioList.length, (actIndex) {
                        ...
                        var audioIdList = List.generate(audioLang == null ? 0 : audioLang.length,
                                (int idIndex) {
