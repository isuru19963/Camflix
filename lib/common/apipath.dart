...
//  static const String domainLink = "https://example.com/public/";
  static const String domainLink = "http://173.82.212.70/";
  ...
  static const String deleteAllWatchHistory = domainApiLink+"delete_watchhistory";
  static const String deleteWatchHistory = domainApiLink+"delete_watchhistory/";
...
*/
  ...
  static const String appName = 'Next Hour';
  static const String androidAppId = 'com.mediacity.nexthour';
...
// Local path to download videos
  static const String localPath = "/data/user/0/${androidAppId}/app_flutter/Download";
