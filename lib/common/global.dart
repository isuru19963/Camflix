...
class Constants{
  ...
  static const List<Color> gradientBlue = [Color(0xFFC6428D), Color(0xFFD189E2)];
  static const List<Color> gradientGreen = [Color(0xFFF09E59), Color(0xFFF4AF64)];
  static const List<Color> gradientYellow = [Color(0xFF9A80F6), Color(0xFFCA7CF2)];
  static const List<Color> gradientPurple = [Color(0xFF304C89), Color(0xFF648DE5)];
  static const List<Color> gradientPink = [Color(0xFF923C01), Color(0xFFEF8B47)];
  static const List<Color> gradientOrange = [Color(0xFF6202E2), Color(0xFFA76AFF)];
  static const List<Color> gradientAmber = [Color(0xFF64E2C2), Color(0xFF68E8CC)];
  static const List gradientColors = [gradientRed, gradientBlue, gradientGreen, gradientYellow, gradientPurple,
    gradientPink, gradientOrange, gradientAmber];
