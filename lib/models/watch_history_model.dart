...
class WatchHistoryModel {
  ...
  factory WatchHistoryModel.fromJson(Map<String, dynamic> json) => WatchHistoryModel(
    watchHistory: json["watch_history"] == null ? null : List<WatchHistory>.from(json["watch_history"].map((x) => WatchHistory.fromJson(x))),
  );

  Map<String, dynamic> toJson() => {
    "watch_history": List<dynamic>.from(watchHistory.map((x) => x.toJson())),
  };
}
...
class WatchHistory {
  ...
  factory WatchHistory.fromJson(Map<String, dynamic> json) => WatchHistory(
    ...
    tvseries: json["tvseries"] == null ? null : Tvseries.fromJson(json["tvseries"]),
  );
