...
class UserProfileModel {
  ...
  factory UserProfileModel.fromJson(Map<String, dynamic> json) => UserProfileModel(
    ...
    currentDate: json["current_date"] == null ? null : DateTime.parse(json["current_date"]),
...
class Paypal {
  ...
  factory Paypal.fromJson(Map<String, dynamic> json) => Paypal(
    ...
    subscriptionFrom: json["subscription_from"] == null ? null : DateTime.parse(json["subscription_from"]),
    subscriptionTo: json["subscription_to"] == null ? null :  json["plan"] == null ? null :  DateTime.parse(json["subscription_to"]),
...
class User {
  ...
  factory User.fromJson(Map<String, dynamic> json) => User(
    ...
    trialEndsAt: json["trial_ends_at"] == null ? null:json["trial_ends_at"],
    ...
    createdAt: json["created_at"] == null ? null: DateTime.parse(json["created_at"]),
    updatedAt: json["updated_at"] == null ? null: DateTime.parse(json["updated_at"]),
    // subscriptions: json["subscriptions"] == null ? null : List<Subscription>.from(json["subscriptions"].map((x) =>
    //     Subscription.fromJson(x))),
  );
