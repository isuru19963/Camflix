import 'package:nexthour/models/top_movies_tv.dart';
...
class GenreModel {
  ...
  factory GenreModel.fromJson(Map<String, dynamic> json) => GenreModel(
    ...
    director: List<Director>.from(json["director"].map((x) => Director.fromJson(x))),
...
class HomeTranslation {
  ...
  factory HomeTranslation.fromJson(Map<String, dynamic> json) => HomeTranslation(
    id: json["id"],
    key: json["key"],
    value: json["value"],
    status: json["status"],
